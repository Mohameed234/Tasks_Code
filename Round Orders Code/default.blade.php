...
@if (($snipeSettings) && ($snipeSettings->allow_user_skin==1) && Auth::check() && Auth::user()->present()->skin != '')
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree" {{ \App\Helpers\Helper::determineLanguageDirection() == 'rtl' ? 'style="margin-right:12px' : '' }}>
                        ...
                        @endcan
						@can('view', \App\Models\InnerLocation::class)
						<li id="innerlocations-sidenav-option" {!! (Request::is('innerlocations*') ? ' class="active"' : '') !!}>
							<a href="{{ route('innerlocations.index') }}">
								<x-icon type="location" class="fa-fw" />
								<span>Hotels Locations</span>
							</a>
						</li>
						@endcan
						@can('view', \App\Models\WorkOrder::class)
						<li id="innerlocations-sidenav-option" {!! (Request::is('work_orders*') ? ' class="active"' : '') !!}>
						...
						@can('view', \App\Models\RoundOrder::class)
						<li id="round-orders-sidenav-option" {!! (Request::is('round-orders*') ? ' class="active"' : '') !!}>
							<a href="{{ route('round-orders.index') }}">
								<i class="fas fa-clipboard-list fa-fw"></i>
								<span>Round Orders</span>
							</a>
						</li>
						@endcan

						@can('view', \App\Models\Checklists::class)
                        <li aria-hidden="true"{!! (Request::is('checklists*') ? ' class="active"' : '') !!}>
    ...
    <li id="filemanagement-sidenav-option" {!! (Request::is('folders*') ? ' class="active"' : '') !!}>
        <a href="{{ route('folders.index') }}">
            <x-icon type="folder" class="fa-fw" />
...
@endcan
            ...
            <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
                ...
                <div class="1hidden-xs pull-left">
                    <div class="pull-left" >
                        <a target="_blank" href="https://so-emi.com" rel="noopener">WareWise</a>
by <a href="https://so-emi.com" rel="noopener">SOEMI</a>.
                    </div>
