...
use App\Http\Controllers\InnerLocationController;
...
use App\Http\Controllers\RoundOrdersController;
...
Route::get('checklists/{checklist}/questions', [ChecklistQuestionController::class, 'index'])->name('checklists.questions.index'); Route::get('checklists/{checklist}/questions/create', [ChecklistQuestionController::class, 'create'])->name('checklists.questions.create');
...
Route::get('/download/{id}', [FileManagerController::class, 'downloadFile'])->name('file.download');
Route::delete('/files/{id}', [FileManagerController::class, 'destroy'])->name('file.delete');	
Route::post('/folders', [FileManagerController::class, 'createFolder'])->name('folders.create');
Route::post('/folders/{folder}/files', [FileManagerController::class, 'uploadFile'])->name('files.upload');
	
	// View Inner Locations
Route::get('innerlocations', [InnerLocationController::class, 'index'])
    ->name('innerlocations.index')
    ->breadcrumbs(function (Trail $trail) {
        $trail->parent('home')
              ->push('Hotels Locations', route('innerlocations.index'));
    });
Route::resource('innerlocations', App\Http\Controllers\InnerLocationController::class);
...
Route::post('/files', [FileManagerController::class, 'store'])->name('files.store');
    ...
    */
    ...
    // Round Orders Routes
    Route::resource('round-orders', RoundOrdersController::class);
    Route::get('round-orders/{roundOrder}/complete', 'RoundOrdersController@complete')->name('round-orders.complete');
    Route::post('round-orders/{roundOrder}/complete', 'RoundOrdersController@markComplete')->name('round-orders.mark-complete');
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'authorize:superuser']], function () {
	...
	Route::get('work_orders', [App\Http\Controllers\WorkOrderController::class, 'index'])
    ->name('work_orders.index')
    ->breadcrumbs(function (Trail $trail) {
        $trail->parent('home')
              ->push('Work Orders', route('work_orders.index'));
    });

Route::resource('work_orders', App\Http\Controllers\WorkOrderController::class);

Route::get('/work_orders/create', [WorkOrderController::class, 'create'])->name('work_orders.create');
